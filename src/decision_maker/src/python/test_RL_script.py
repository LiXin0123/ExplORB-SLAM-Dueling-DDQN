...
class ActiveSLAM:
    ...
    def check_new_csv_files(self):
        folder_path = '/home/lx23/Downloads/explORB-SLAM-RL/src/decision_maker/src/python/RL/csv/temp' + \
    ...
    def save_image(self):
        ...
        file_path_not_completed = '/home/lx23/Downloads/explORB-SLAM-RL/src/decision_maker/src/python/RL/rviz_results/' + gazebo_env + '/' + \
        ...
        file_path_completed = '/home/lx23/Downloads/explORB-SLAM-RL/src/decision_maker/src/python/RL/rviz_results/' + gazebo_env + '/' +\
