...
if __name__ == "__main__":
    ...
    for algo in algos:
        for repeat_count in repeat_counts:
            base_folder_path = f'/home/lx23/Downloads/explORB-SLAM-RL/src/decision_maker/src/python/RL/rviz_results/{gazebo_env}/{algo}/{repeat_count}'
            original_img = f"/home/lx23/Downloads/explORB-SLAM-RL/src/decision_maker/src/python/RL/similar_images/base/{best_picture}.png"

            for cnn_model in cnn_models:
                # Create a new directory to store similar images based on the CNN model chosen
                similar_images_folder = f'/home/lx23/Downloads/explORB-SLAM-RL/src/decision_maker/src/python/RL/similar_images/{gazebo_env}/{algo}/{cnn_model}'
