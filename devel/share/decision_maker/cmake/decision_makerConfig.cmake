...
if("TRUE" STREQUAL "TRUE")
  set(decision_maker_SOURCE_PREFIX /home/lx23/Downloads/explORB-SLAM-RL/src/decision_maker)
  set(decision_maker_DEVEL_PREFIX /home/lx23/Downloads/explORB-SLAM-RL/devel)
  ...
  set(decision_maker_INSTALL_PREFIX /home/lx23/Downloads/explORB-SLAM-RL/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'decision_maker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lx23/Downloads/explORB-SLAM-RL/src/decision_maker/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(decision_maker_EXPORTED_TARGETS ${${decision_maker_dep}_EXPORTED_TARGETS})
endforeach()
